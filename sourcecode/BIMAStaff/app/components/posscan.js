...
export default class POSScan extends Component {
  ...
  render() {
    const handleBarCodeScanned = ({ type, data }) => {
      ...
      this.setState({quantityvalue: firebase.database().ref('inventory/' + this.state.managerid + '/' + data).child('quantity')})
      this.copyFirebaseObject(firebase.database().ref('inventory/' + this.state.managerid + '/' + data), 
